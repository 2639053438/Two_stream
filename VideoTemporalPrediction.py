...
def VideoTemporalPrediction(
    ...
    for i in range(num_samples):
        for j in range(optical_flow_frames):
            # 获取图片的地址:/home/yzhu25/Documents/UCF101/ucf101_flow_img_tvl1_gpu/ApplyEyeMakeup/v_ApplyEyeMakeup_g01_c05/flow_x_000i.jpg
